...
app.use('/api/offer-letter/getofferletterbyemail', require('./routes/student/offer-letter-getofferletterbyemail'));
app.use('/api/offer-letter/getStatus', require('./routes/student/offer-letter-getStatus'));
app.use('/api/offer-letter/updatestatus', require('./routes/student/offer-letter-updatestatus'));
app.use('/api/programs/getprogrambycourseid', require('./routes/student/programs-getprogrambycourseid'));
app.use('/api/programs/getprogrambyid', require('./routes/student/programs-getprogrambyid'));
app.use('/api/universities/getprogramsbyuniversityid', require('./routes/student/universities-getprogramsbyuniversityid'));
app.use('/api/universities/getuniversitiesbycountryid', require('./routes/student/universities-getuniversitiesbycountryid'));
app.use('/api/universities/getuniversitybyid', require('./routes/student/universities-getuniversitybyid'));
app.use('/api/airport-pickup', require('./routes/student/airport-pickup'));
app.use('/api/airport-pickup-get-status', require('./routes/student/airport-pickup-get-status'));
app.use('/api/airport-pickup-airport-ticket', require('./routes/student/airport-pickup-airport-ticket'));
app.use('/api/application-submitted', require('./routes/student/application-submitted'));
app.use('/api/application-submitted-get-status', require('./routes/student/application-submitted-get-status'));
app.use('/api/register', require('./routes/student/register'));
app.use('/api/login', require('./routes/student/login'));
app.use('/api/forget-password', require('./routes/student/forget-password'));
app.use('/api/update-profile', require('./routes/student/update-profile'));
...
app.use('/api/documentverify', require('./routes/student/documentverify'));
app.use('/api/scan-documents', require('./routes/student/scan-documents'));
app.use('/api/scan-documents/bachelor-scan', require('./routes/student/scan-documents-bachelor-scan'));
app.use('/api/scan-documents/is-arts-student', require('./routes/student/scan-documents-is-arts-student'));
app.use('/api/scan-documents/is-commerce-student', require('./routes/student/scan-documents-is-commerce-student'));
app.use('/api/scan-documents/is-medical-student', require('./routes/student/scan-documents-is-medical-student'));
app.use('/api/scan-documents/is-nonmedical-student', require('./routes/student/scan-documents-is-nonmedical-student'));
app.use('/api/getdocumentsbyemail', require('./routes/student/send-document-getdocumentbyemail'));
app.use('/api/send-payment-reciept', require('./routes/student/send-payment-reciept'));
app.use('/api/appointment-notification-getreminder', require('./routes/student/appointment-notification-getreminder'));
app.use('/api/checklist-documents-get-documents', require('./routes/student/checklist-documents-get-documents'));
app.use('/api/checklist-documents-get-documents-get-status', require('./routes/student/checklist-documents-get-documents-get-status'));
app.use('/api/countries/allcountries', require('./routes/student/countries-allcountries'));
app.use('/api/countries/country_code', require('./routes/student/countries-country_code'));
app.use('/api/documentverify/detect-stream', require('./routes/student/documentverify-detect-stream'));
app.use('/api/documentverify/getStatus', require('./routes/student/documentverify-getStatus'));
app.use('/api/documentverify/iseligible', require('./routes/student/documentverify-iseligible'));
app.use('/api/documentverify/iseligible-getStatus', require('./routes/student/documentverify-iseligible-getStatus'));
app.use('/api/documentverify/updatetozero', require('./routes/student/documentverify-updatetozero'));
app.use('/api/embassy/embasy/doc-status', require('./routes/student/embassy-embasy-doc-status'));
app.use('/api/embassy/save-email', require('./routes/student/embassy-save-email'));
app.use('/api/embassy/visa-result', require('./routes/student/embassy-visa-result'));
app.use('/api/embassy/visa-status', require('./routes/student/embassy-visa-status'));
app.use('/api/embassy/visa-status/get-visa', require('./routes/student/embassy-visa-status-get-visa'));
app.use('/api/embassy/visa-status/get-visa-status', require('./routes/student/embassy-visa-status-get-visa-status'));
